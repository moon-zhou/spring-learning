 ...
 * 功能描述: 切面处理<br>
 *
 * 此示例：切点的定义不够灵活，切点直接写在每一个注解里，如果要修改切点，每个方法上都要修改，因此，我们可以将切点统一定义，然后统一调用。详见V2
 * @author moon-zhou
 * @see [相关类/方法]（可选）
 * @since [产品/模块版本] （可选）
 */
...
public class MoonLogAspectV1 {
    ...
    public void before(JoinPoint joinPoint) {
        ...
        System.out.println(name + " 方法开始执行了 V1......");
    }
    ...
    public void after(JoinPoint joinPoint) {
        ...
        System.out.println(name + " 方法执行结束了 V1......");
    }
    ...
    public void returning(JoinPoint joinPoint, Integer returnValue) {
        ...
        System.out.println(name + " 方法返回值 V1： " + returnValue);
    }
    ...
    public void afterThrowing(JoinPoint joinPoint, Exception e) {
        ...
        System.out.println(name + " 方法抛出异常 V1： " + e.getMessage());
    }
