 ...
 * @since [产品/模块版本] （可选）
 */
@WebFilter(urlPatterns = {"/dispatcher/forward2"}, dispatcherTypes = {DispatcherType.FORWARD})
public class ForwardFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        LOGGER.info("Inside ForwardFilter start: {}", req.getRequestURI());
        chain.doFilter(request, response);
        LOGGER.info("Inside ForwardFilter end: {}, {}", req.getRequestURI(), response.getContentType());
    }
