 ...
 */
@RestController
@RequestMapping("/aonline")
public class AOnlineController {


    /**
     * 测试直接返回字符串内容
     * http://localhost:8080/aonline/retStr
     *
     * @return
     */
    ...
    /**
     * 测试返回动态页面
     * http://localhost:8080/aonline/retDynamicPage
     *
     * 测试直接访问静态页面
    ...
    /**
     * 测试返回json数据
     * http://localhost:8080/aonline/retJson
     * @return
     */
